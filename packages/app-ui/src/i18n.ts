  ...
  en: {
    translation: {
      ...
      global: {
        ...
        partial: "Partially completed. Retry the same operation to converge.",
      ...
      diagnostics: {
        ...
        notScanned: "Diagnostics have not been scanned",
        notScannedHint: "Run the full read-only scan when you need detailed diagnostics. It never runs in the background.",
        repairTitle: "Targeted repair",
        repairHint: "Choose only the metadata you want to repair. Provider synchronization remains a separate operation.",
        repairTargetRequired: "Select at least one repair target.",
        workspaceRootsIncludesCwd: "Workspace roots automatically include cwd repair.",
        prepareRepair: "Prepare repair",
        repairTargets: {
          models: "Historical models",
          cwd: "Thread cwd",
          userEvent: "User-event flags",
        ...
        fields: {
          ...
          rolloutModelFilesNeedingRepair: "Rollouts needing model repair",
          sqliteModelRowsNeedingRepair: "SQLite model rows needing repair",
          cwdRowsNeedingRepair: "cwd rows needing repair",
          userEventRowsNeedingRepair: "User-event rows needing repair",
          workspaceRootsNeedingRepair: "Workspace roots needing repair",
          encryptedContentFiles: "Files containing encrypted content",
      ...
      operationResult: {
        ...
        fields: {
          ...
          sqliteModelRowsUpdated: "Model rows updated",
        ...
        partial: {
          ...
          description: "Some requested changes were not completed. Retry the same operation to converge, or restore the managed backup."
        },
        failedRolledBack: {
  ...
  "zh-CN": {
    translation: {
      ...
      diagnostics: {
        ...
        runScan: "运行完整扫描",
        notScanned: "尚未运行诊断扫描",
        notScannedHint: "需要详细信息时再手动运行完整只读扫描；不会在后台自动执行。",
        repairTitle: "专项修复",
        repairHint: "只选择需要修复的元数据；Provider 同步仍是独立操作。",
        repairTargetRequired: "请至少选择一个修复目标。",
        workspaceRootsIncludesCwd: "工作区根目录修复会自动包含 cwd 修复。",
        prepareRepair: "生成修复计划",
        repairTargets: {
          models: "历史模型",
          cwd: "线程 cwd",
          userEvent: "用户事件标记",
        ...
        fields: {
          ...
          rolloutModelFilesNeedingRepair: "需要模型修复的 rollout",
          sqliteModelRowsNeedingRepair: "需要模型修复的 SQLite 行",
          cwdRowsNeedingRepair: "需要修复的 cwd 行",
          userEventRowsNeedingRepair: "需要修复的用户事件行",
          workspaceRootsNeedingRepair: "需要修复的工作区根目录",
          encryptedContentFiles: "包含加密内容的文件",
      ...
      operationResult: {
        ...
        partial: {
          title: "部分完成",
          description: "部分请求尚未完成。请重试同一操作使状态收敛，或手动恢复受管备份。"
        },
        failedRolledBack: {
          title: "失败并已回滚",
