...
完整中文说明以仓库根目录的 [README.md](../README.md) 为准，包括适用场景、当前已发布的 Windows .NET GUI、未发布的 vNext Electron 候选、可选本地 Web UI、CLI、SQLite Home 解析、安全限制和开发命令。

专项文档：

- [Web UI 中文指南](README_WEB_UI_ZH.md)
- [Windows GUI 说明](README_GUI_ZH.md)
- [vNext Electron 桌面端候选说明](README_DESKTOP_ZH.md)
